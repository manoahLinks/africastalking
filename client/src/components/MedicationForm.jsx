...
function MedicationForm() {
  ...
  return (
    <div className="flex flex-col gap-y-4">
      ...
      <div className="grid grid-cols-[300px_203px_auto] gap-x-[24px]">
        <div className="flex flex-col gap-y-2">
          <small>Medicine</small>
          <input
            type="text"
            name="medicine"
            className="text-xs placeholder-slate-300 border w-[300px] border-slate-300 rounded-md"
      ...
      {orderList.length !== 0 && (
        <div>
          <div className="grid grid-cols-[300px_203px_auto] gap-x-[24px] text-black  text-base font-normal">
          ...
          <div className="flex flex-col gap-y-2">
            {orderList.map((order, i) => (
              <div
                key={i}
                className="grid grid-cols-[300px_auto] gap-x-[24px] text-blackLight300 text-base font-light"
              >
                <h2>{order.medcine}</h2>
                <h2>{order.dosage}</h2>
              </div>
